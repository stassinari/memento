...
2. Navigate to your _Settings_ page and generate a **secret key**
3. You're going to need both your **User ID** and your **secret key** (both on the _Settings_ page for easy copy/pasting)

From the GitHub repo:

3. Download the [`plugin.tcl` file](external/decent/memento_uploader/plugin.tcl) to your computer
4. (Optional) Download the [`settings.tdb` file](external/decent/memento_uploader/settings.tdb) to your computer. If you skip this step, you'll have to enter your User ID and secret manually from the tablet interface
   - Open the `settings.tdb` file with any text editor and replace the `memento_username` and `memento_password` values with your **User ID** and **secret key** respectively
...
8. If you transferred the `settings.tdb` file, you're all set! If you haven't, open the settings page for the extension and enter your **User ID** and **secret key**
