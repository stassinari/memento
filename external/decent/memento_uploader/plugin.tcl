...
set plugin_name "memento_uploader"
...
namespace eval ::plugins::${plugin_name} {
    ...
    proc create_ui {} {
        ...
        if {[array size ::plugins::memento_uploader::settings] == 0} {
            array set  ::plugins::memento_uploader::settings {
                auto_upload 1
        ...
        if { ![info exists ::plugins::memento_uploader::settings(last_upload_shot)] } {
            set ::plugins::memento_uploader::settings(last_upload_shot) {}
            set ::plugins::memento_uploader::settings(last_upload_result) {}
            set ::plugins::memento_uploader::settings(last_upload_id) {}
            set ::plugins::memento_uploader::settings(auto_upload_min_seconds) 6
            set ::plugins::memento_uploader::settings(memento_browse_url) "https://brewlog-early-test.netlify.app/espresso/<ID>/decent"
            set needs_save_settings 1
        }
        if { $needs_save_settings == 1 } {
            plugins save_settings memento_uploader
        }
        ...
        add_de1_button $page_name {say [translate {Done}] $::settings(sound_button_in); save_plugin_settings memento_uploader; fill_extensions_listbox; page_to_show_when_off extensions; set_extensions_scrollbar_dimensions}  980 1210 1580 1410 ""
        ...
        add_de1_widget "$page_name" entry 280 540  {
            bind $widget <Return> { say [translate {save}] $::settings(sound_button_in); borg toast [translate "Saved"]; save_plugin_settings memento_uploader; hide_android_keyboard}
            bind $widget <Leave> hide_android_keyboard
            } -width [expr {int(38 * $::globals(entry_length_multiplier))}] -font Helv_8  -borderwidth 1 -bg #fbfaff  -foreground #4e85f4 -textvariable ::plugins::memento_uploader::settings(memento_username) -relief flat  -highlightthickness 1 -highlightcolor #000000
            ...
            add_de1_widget "$page_name" entry 280 720  {
                bind $widget <Return> { say [translate {save}] $::settings(sound_button_in); borg toast [translate "Saved"]; save_plugin_settings memento_uploader; hide_android_keyboard}
                bind $widget <Leave> hide_android_keyboard
                } -width [expr {int(38 * $::globals(entry_length_multiplier))}] -font Helv_8  -borderwidth 1 -bg #fbfaff  -foreground #4e85f4 -textvariable ::plugins::memento_uploader::settings(memento_password) -relief flat  -highlightthickness 1 -highlightcolor #000000

                # Auto-Upload
                add_de1_widget "$page_name" checkbutton 280 840 {} -text [translate "Auto-Upload"] -indicatoron true  -font Helv_8 -bg #FFFFFF -anchor nw -foreground #4e85f4 -variable ::plugins::memento_uploader::settings(auto_upload)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF  -bd 0 -activeforeground #4e85f4 -relief flat -bd 0
                ...
                add_de1_widget "$page_name" entry 280 980  {
                    ...
                    bind $widget <Leave> hide_android_keyboard
                    } -width [expr {int(3* $::globals(entry_length_multiplier))}] -font Helv_8  -borderwidth 1 -bg #fbfaff  -foreground #4e85f4 -textvariable ::plugins::memento_uploader::settings(auto_upload_min_seconds) -relief flat  -highlightthickness 1 -highlightcolor #000000

                    # Last upload shot
                    add_de1_text $page_name 1450 480 -text [translate "Last upload:"] -font Helv_8 -width 300 -fill "#444444" -anchor "nw" -justify "center"
                    add_de1_variable $page_name 1450 540 -font Helv_8 -width 400 -fill "#4e85f4" -anchor "nw" -justify "left" -textvariable {[translate "Shot started on"] [time_format $::plugins::memento_uploader::settings(last_upload_shot)]}

                    # Last upload result
                    add_de1_text $page_name 1450 660 -text [translate "Result:"] -font Helv_8 -width 300 -fill "#444444" -anchor "nw" -justify "center"
                    add_de1_variable $page_name 1450 720 -font Helv_8 -width 400 -fill "#4e85f4" -anchor "nw" -justify "left" -textvariable {$::plugins::memento_uploader::settings(last_upload_result)}

                    # Browse last uploaded shot in
                    set ::plugins::memento_uploader::browse_widget [add_de1_text $page_name 1450 920 -text "\[ [translate {Open shot in visualizer.coffee}] \]" -font Helv_8 -width 300 -fill "#4e85f4" -anchor "nw" -justify "left"]
                    add_de1_button $page_name ::plugins::memento_uploader::browse 1440 910 2200 990

                    # Ensure stuff is done whenever the page is shown.
                    add_de1_action $page_name ::plugins::memento_uploader::show_settings_page
                ...
                proc show_settings_page { } {
                    variable settings
                    canvas_hide_if_zero [expr { [info exists settings(last_upload_id)] && $settings(last_upload_id) ne "" }] $::plugins::memento_uploader::browse_widget
                }
                ...
                proc uploadShotData {} {
                    ...
                    if { ! $settings(auto_upload) } {
                        ...
                        save_plugin_settings memento_uploader
                        return
                    }
                ...
                proc main {} {
                    plugins gui memento_uploader [create_ui]
                    ::de1::event::listener::after_flow_complete_add \
                        [lambda {event_dict} {
                            ::plugins::memento_uploader::async_dispatch \
