        ...
        {options.map((option) => (
          <RadioGroup.Option
            ...
            className={clsx([
              ...
              "ui-not-checked:bg-white ui-not-checked:border-gray-200 ui-not-checked:text-gray-700 ui-not-checked:hover:bg-gray-50",
              variant === "primary"
                ? "ui-checked:bg-orange-600 ui-checked:border-transparent ui-checked:text-white ui-checked:hover:bg-orange-700 ui-active:ring-2 ui-active:ring-offset-2"
                : variant === "secondary"
                  ? "ui-checked:text-orange-700 ui-checked:bg-orange-100 ui-checked:border-transparent ui-checked:hover:bg-orange-200 ui-not-checked:focus:border-orange-500 ui-active:ring-1 ui-active:border-orange-500"
                  : null,
              option.disabled
