...
export const TastingSamplesShell = ({ title = "Samples", list, children }: TastingSamplesShellProps) => (
  <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xs dark:border-white/10 dark:bg-gray-900">
    <div className="grid grid-cols-12">
      <aside className="col-span-12 border-b border-gray-200 bg-gray-50/60 dark:border-white/10 dark:bg-white/5 sm:col-span-4 sm:border-b-0 sm:border-r">
      ...
      <main className="col-span-12 bg-white p-4 dark:bg-gray-900 sm:col-span-8">{children}</main>
    </div>
  </div>
);
